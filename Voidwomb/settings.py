"""
Django settings for Voidwomb project.
...
ALLOWED_HOSTS = ['8865-2-83-105-229.ngrok-free.app', '13.48.86.160', '127.0.0.1']
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'Adm/templates'), os.path.join(BASE_DIR, 'Void/templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
                ...
                'Void.context_processors.cart_context',
            ],
        },
    },
]

WSGI_APPLICATION = 'Voidwomb.wsgi.application'
